  ...
  return {
    ...
    '/__debugger__': (req) => {
      ...
      const body = replaceVariables(fileContents, globalConstants, {
        ...
        latestMockRequest: latestMockRequest || `Not called since run-amock started at ${startDateStr}`,
        internalState: handlers || `Not called since run-amock started at ${startDateStr}`,
